...
regex_non_english_chars = re.compile(r"[^a-zA-Z'\-,.!?:;() \"áéíóúÁÉÍÓÚüüñÑ]")
...
def containsForeignTerm(words): 
    ...
    for w in words:
        ...
        for sw in sub_words:
            ...
            # Case sensitive
            full_patterns = set(["le","ng","les","al","du","dil","ma","fu","pe","im","Ii","ni","Tl","Bt","va"])
            ...
            # Case insensitive
            full_insensitive_patterns = set(["og","la","ap","ibn","et","ga","aj","ud", \
            "ix","ich","zur","und","jou","jus","qui","tu","il","avec","vous","yr","ar","sa","auf","ny", \
            "vi","ein","ist","alte","mon","lui","mi","rasa","zu","mit","von","au","je","ne","jah","uz","png", \
            "ja","za","ka","ba","ch","lok","ool","ry","haq","huq","ul","ga","dh","pe","aa","ke","ona","ww","ak", \
            "mi","fa","ji","deg","gu","toh","ar","ge","rrh","aoi","och","fod","megc","om","ol","ua","pu","ee","xie","nwo", \
            "sui","siya","amr","ach","hb","scfv","unde","hsi","fn","dwb","sul","liw","ecce","tui","teh","kut","ausf","vo","het","nam", \
            "deh","tha","phra","tho","thu","dux","okul","blok","ust","vor","tchee","hee","chik","ju","kik","chee", \
            "ost","ong","fac","qua","tugh","ulus","krack","koto","bint","qin","ki","nig","ook","ter","sint","fo","sed","cao","kot","hof", \
